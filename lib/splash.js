...
export default function splash ({
  ...
  let div = dom(
    ...
    dom(
      ...
      dom(
        'input.form-item type=email name=email placeholder=you@domain.com ' +
          (!iframe ? 'autofocus' : '')
      ),
      (large && iframe) || !large & !iframe ? dom('br') : null,
...
function style ({ logo, active, large, iframe } = {}) {
  ...
  css.add('.splash', {
    width: iframe ? (large ? '23.6rem' : '25rem') : '30rem',
    margin: iframe ? '0 auto' : '10vw auto',
    'text-align': 'center',
