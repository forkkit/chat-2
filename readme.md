...
```bash
now microlinkhq/chat
```

Other platforms:

- [Heroku](https://heroku.com/deploy?template=https://github.com/microlinkhq/chat/tree/master)
- [Azure](https://azuredeploy.net/)
- [OpenShift](https://github.com/microlinkhq/chat/wiki/OpenShift)
- [IBM Bluemix](https://bluemix.net/deploy?repository=https://github.com/microlinkhq/chat)
